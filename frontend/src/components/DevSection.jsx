...
function DeveloppementWebSection() {
  return (
    <div className="p-10 bg-gradient-to-r from-blue-500 to-indigo-500 text-white rounded-lg shadow-xl">
      ...
      <p className="text-lg mb-6">Le développement web est un domaine en constante évolution. Explorez les dernières tendances et technologies, des frameworks modernes aux meilleures pratiques de codage.</p>
