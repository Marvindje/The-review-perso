      ...
      <div className="flex justify-center items-center mt-64 mb-0">
        <div className="grid grid-cols-2 gap-6">
          {[...Array(4)].map((_, i) => (
            <motion.div
              key={i}
              className="bg-gradient-to-r from-blue-500 to-cyan-500 rounded-lg overflow-hidden shadow-lg p-6 hover:bg-blue-500 hover:text-white transition-colors duration-200"
            ...
            >
              ...
              <Link
                to={`/article${i + 1}`}
                className="text-white text-sm mt-4 block hover:text-white"
              >
                Lire l'article
              </Link>
            </motion.div>
