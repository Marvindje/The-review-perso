...
import logicielsImage from '../assets/loggggiciel.jpeg';

const Logiciels = () => {
  return (
    <div className="font-body">
      {/* Hero section */}
      <div className="relative h-screen flex items-center justify-center bg-cover bg-center shadow-2xl" style={{ backgroundImage: `url(${logicielsImage})` }}>
        <h1 className="text-5xl text-white font-header text-center bg-gradient-to-r from-black to-transparent py-2 px-4 rounded hover:text-blue-500 transition-colors duration-200">
          Bienvenue dans la section Logiciels
        </h1>
      </div>
