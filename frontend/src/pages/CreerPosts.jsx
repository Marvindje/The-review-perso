    ...
    >
      ...
      >
        ...
        <div className='flex items-center mb-4'>
          <button type='button' onClick={handleLike} className='focus:outline-none'>
            <FaThumbsUp className={`mr-2 ${liked ? 'text-blue-500' : ''}`} />
          </button>
          <p className='text-gray-500'>{likes} likes</p>
        </div>
        <button type='button' onClick={handlePostClick} className='px-4 py-2 bg-blue-500 text-white rounded-md'>
          Post
        </button>
      </motion.div>
    </motion.div>
